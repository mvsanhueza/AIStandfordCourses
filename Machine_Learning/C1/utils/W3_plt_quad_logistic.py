...
from utils.W3_lab_utils_common import np, plt, dlc, dlcolors,sigmoid,compute_cost_matrix, gradient_descent
...
class data_plot:
    ...
    def plt_tumor_data(self):
        ...
        pos = y == 1
        neg = y == 0
        self.ax.scatter(x[pos],y[pos], marker='x', s=80, c='r', label='malignant')
    ...
    def mk_cost_lines(self, firsttime=False):
        ...
        ## todo.. figure out how to get the textbox to extend to the width of the subplot
